    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 backdrop-blur-md bg-white/90">
      <div className="container mx-auto px-4 max-w-7xl h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/" className="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">Apostilas</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-white border-b border-slate-200 shadow-xl animate-in slide-in-from-top duration-200 z-50">
          <div className="flex flex-col p-4 gap-4">
            ...
            <Link to="/" className="text-base font-medium text-slate-700 py-2 hover:text-indigo-600 active:bg-slate-50 rounded" onClick={() => setIsMenuOpen(false)}>Apostilas</Link>
            {user && (
