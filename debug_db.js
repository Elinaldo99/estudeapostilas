...
async function check() {
    ...
    const { data: h, error: he } = await supabase.from('handouts').select('category').limit(10);
    if (he) console.log('H error:', he.message);
        ...
        console.log('Handout categories found:', JSON.stringify(counts, null, 2));
    }
    ...
    if (se) console.log('S error:', se.message);
        ...
        console.log('Subcategories found:', JSON.stringify(s, null, 2));
    }
}
